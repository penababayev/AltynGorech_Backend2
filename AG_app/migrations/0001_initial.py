    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='courses', to='AG_app.branch', verbose_name='Şube')),
            ],
            options={
                'verbose_name': 'Kurs',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['last_name', 'first_name'], name='AG_app_guar_last_na_54cd72_idx'), models.Index(fields=['phone'], name='AG_app_guar_phone_a62ba6_idx')],
            },
        ),
        migrations.CreateModel(
            name='Invoice',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='students', to='AG_app.branch', verbose_name='Şube')),
            ],
            options={
                'verbose_name': 'Okuwçy',
        ...
        migrations.AddField(
            ...
            name='student',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='enrollments', to='AG_app.student'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('guardian', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='student_links', to='AG_app.guardian')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='guardian_links', to='AG_app.student')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(db_index=True, max_length=32, unique=True, verbose_name='Konu Kodu')),
                ('name', models.CharField(max_length=120, verbose_name='Konu Adı')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['name', 'level'], name='AG_app_subj_name_d16c84_idx'), models.Index(fields=['is_active'], name='AG_app_subj_is_acti_bca5ce_idx')],
        ...
        migrations.AddField(
            model_name='course',
            name='subject',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='courses', to='AG_app.subject', verbose_name='Konu'),
        ),
        migrations.CreateModel(
            name='Submission',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('branch', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='teachers', to='AG_app.branch', verbose_name='Şube')),
                ('subjects', models.ManyToManyField(blank=True, related_name='teachers', to='AG_app.subject', verbose_name='Verdiği Konular')),
        ...
        migrations.AddField(
            model_name='course',
            name='teacher',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='courses', to='AG_app.teacher', verbose_name='Eğitmen'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['student', 'guardian'], name='AG_app_stud_student_9eac93_idx'),
        ),
        migrations.AddIndex(
            model_name='studentguardian',
            index=models.Index(fields=['student', 'is_primary'], name='AG_app_stud_student_7a4332_idx'),
        ),
        ...
        migrations.AddIndex(
            model_name='teacher',
            index=models.Index(fields=['last_name', 'first_name'], name='AG_app_teac_last_na_27ab03_idx'),
        ),
        migrations.AddIndex(
            model_name='teacher',
            index=models.Index(fields=['branch', 'status'], name='AG_app_teac_branch__23b2bf_idx'),
        ),
        migrations.AddIndex(
            model_name='course',
            index=models.Index(fields=['status', 'is_active'], name='AG_app_cour_status_9af9cb_idx'),
        ),
        migrations.AddIndex(
            model_name='course',
            index=models.Index(fields=['branch', 'start_date'], name='AG_app_cour_branch__9b9830_idx'),
        ),
        migrations.AddIndex(
            model_name='course',
            index=models.Index(fields=['subject', 'teacher'], name='AG_app_cour_subject_95e572_idx'),
        ),
        migrations.AddConstraint(
            model_name='course',
