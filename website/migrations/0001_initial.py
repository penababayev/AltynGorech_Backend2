...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.JSONField(default=dict, verbose_name='Sapagyň kurs adlandyrmalary')),
                ('description', models.JSONField(default=dict, help_text='Kursuň giňişleýin açyklamasy', verbose_name='Açyklama')),
