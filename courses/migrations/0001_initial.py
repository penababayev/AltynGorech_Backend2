    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('lesson', 'Lesson'), ('exam', 'Exam'), ('event', 'Event')], default='lesson', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(blank=True, db_index=True, max_length=32, null=True, verbose_name='Oda Kodu')),
                ('name', models.CharField(max_length=50, verbose_name='Oda Adı')),
                ('capacity', models.PositiveIntegerField(default=20, validators=[django.core.validators.MinValueValidator(1)], verbose_name='Kapasite')),
                ('building', models.CharField(blank=True, max_length=60, verbose_name='Bina')),
                ('floor', models.CharField(blank=True, max_length=20, verbose_name='Kat')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.JSONField(default=dict, verbose_name='Ders Adı')),
